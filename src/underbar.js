(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    _.each(arrayCopy, function(item) {
      var item = (iterator !== undefined) ? iterator(item) : item;
      if (isSorted) {
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    //////// RECURSIVE Implementation -- should pass as well! ////////
    ...
    //   }
    //   accumulator = iterator(accumulator, item);
    //   return _.reduce(array, iterator, accumulator);
    // }
    // else if (array.length === 1 && accumulator !== undefined) {
    //   accumulator = iterator(accumulator, array[0])
    // } else {
    //   accumulator = array[0];
    // }
